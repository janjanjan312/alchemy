...
export default function Vessel({ userId, onInsightArchive, onContentUpdate, openArchetypes = [], activeArchetype, onSelectArchetype, onCloseArchetype }: VesselProps) {
  ...
  return (
    <div className="flex flex-col h-full max-w-4xl mx-auto px-4">
      {/* Mode Switcher */}
      <div ref={modeBarRef} className="flex items-center gap-3 py-4 overflow-x-auto no-scrollbar">
        {!isArchetypeActive && (
          <button
            onClick={openSidebar}
      ...
      <div className="pb-1 pt-2">
        <div className="flex items-center gap-2.5 w-full">
          ...
          {inputMethod === 'voice' ? (
            ...
            <div className="flex-1 flex items-center gap-1.5 bg-white/8 rounded-2xl px-3 min-h-[48px]">
              <textarea
                ref={textareaRef}
                value={input}

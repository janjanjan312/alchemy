...
const TOPIC_POOL = [
  '我总觉得自己在扮演一个角色，真实的我好像藏在面具后面',
  '有些人明明不重要，但我就是特别在意他们的评价',
  '我反复做类似的梦，不知道代表什么',
  '为什么我总是反复爱上同一类型的人？',
  '我发现自己很容易被某一类人吸引，但结果总是不好',
  '有时候我会突然感到莫名的空虚，不知道自己在追求什么',
  '我好像总是在逃避冲突，即使心里很不爽',
  '我经常感觉"这不像真正的我"，但说不清真正的我是什么样',
  '我对某个人又爱又恨，这种矛盾的感觉让我很困惑',
  '我发现自己在重复父母的某些行为模式',
  '有些童年记忆一直影响着我，但我说不清楚为什么',
  '我害怕独处，但和人在一起又觉得累',
  '我总觉得自己还没有"活出来"，但不知道缺了什么',
  '最近有件事让我情绪反应特别大，事后想想好像不至于',
  '我对未来有一种说不清的恐惧',
  '我特别讨厌某个人身上的某个特质，但别人好像没那么在意',
];
  ...
  return (
    <div className="flex flex-col h-full max-w-4xl mx-auto px-3 lg:px-4">
      ...
      >
            ...
            >
              ...
              {msg.symbol && (
                <motion.div
                  initial={{ scale: 0.9, opacity: 0 }}
                  animate={{ scale: 1, opacity: 1 }}
                  className="mt-4 p-4 rounded-xl border border-emerald-500/30 bg-emerald-500/5 max-w-[280px] lg:max-w-xs"
                >
                  <div className="flex items-center gap-2 mb-2">
                    <BookOpen size={16} className="text-emerald-400" />
                    <span className="text-xs uppercase tracking-widest font-sans font-bold text-emerald-400">新象征</span>
                  </div>
                  ...
                  <button
                    ...
                    className="w-full py-2.5 rounded-xl bg-emerald-500/80 text-white text-sm font-sans font-bold hover:bg-emerald-500 transition-colors"
                  >
                    存入词典
                  </button>
                </motion.div>
        ...
        {mode === 'Free Talk' && messages.length <= 1 && !isThinking && (
